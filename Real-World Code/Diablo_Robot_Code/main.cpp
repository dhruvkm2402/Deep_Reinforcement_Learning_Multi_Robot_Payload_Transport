...
void twist_ctrl(const geometry_msgs::Twist::ConstPtr& msg)
{
...
int main(int argc, char** argv)
{
    ...
    ros::Subscriber teleop_sub = nh.subscribe("/DJ_teleop2", 1, teleop_ctrl); //subscribe to ROS topic
    ros::Subscriber twist_sub = nh.subscribe("/cmd_vel_follower", 1, twist_ctrl); //subscribe to ROS topic
